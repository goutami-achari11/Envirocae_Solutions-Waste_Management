...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<a href="addbin.php" class="nav-item nav-link ">Add bins</a>
                ...
                <a href="viewfeedback.php" class="nav-item nav-link">View Reviews</a>
                <a href="viewuser.php" class="nav-item nav-link">View Users</a>
               <a href="#" class="nav-item nav-link active">View Workers</a>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Our workers</h1>
			   ...
			   $conn =connectdb();
                ...
                <div  class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div style="float:left;" class="team-item rounded">
                        <img style="width:400px;height:400px;" class="img-fluid" src="workers/'.$row["wimg"].'" alt="">
                        <div class="team-text">
                           <h4 class="mb-0"> Name: '.$row["dname"].'</h4>
							...
							<p class="text-primary">Vehicle No: '.$row["truckno"].'</p>
							<a style="color:red;" class="read_more" href="allactions.php?email='.$row["email"].'"> Remove worker?</a>
							 </div>
