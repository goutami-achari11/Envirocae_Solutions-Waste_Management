                    ...
                    <div style="float:left;" class="team-item rounded">
                        ...
                        <div class="team-text">
                           ...
                           <h4 class="mb-0"> Dust-bin Name: '.$row["dbname"].'</h4>
							...
							<a style="background-color:green;color:white;width:100px;"  class="btn btn-square  me-2" href="bins.php?dbid='.$row["dbid"].'">Request</a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h3 class="f text-white mb-4">Our Office</h3>
                ...
                <div class="col-lg-3 col-md-6">
                    <h3 class="f" style="color:white;">Services</h3><br>
                ...
                <div class="col-lg-3 col-md-6">
                    <h3 class="f" style="color:white;">Quick Links</h3><br>
