...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a style="font-weight:bold;" href="newbin.php" class="nav-item nav-link">New dust-bins</a>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">New Wastes</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                 
                    <li class="breadcrumb-item"><a href="Workerdb.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">New Wastes</li>
                </ol>
            </nav>
        </div>
    </div>
			...
			<div  class="row g-4">
			 ...
			 <?php
			   ...
			   $conn =connectdb();
				...
				$sql="Select * from add_waste WHERE status='Approval Pending'" ;
   ...
   <div class="container-fluid bg-dark text-light footer mt-5 py-5 wow fadeIn" data-wow-delay="0.1s">
        <div style="boarder:5px;color:white;" class="container py-5">
            <div class="row g-5">
                ...
                <a style="color:white; font-size:19px; width:290px;" href="newbin.php" class="btn btn-link">New dust-bins</a>
