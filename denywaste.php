...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Dynied wastes</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    
                    <li class="breadcrumb-item"><a href="workerdb.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Dynied Wastes</li>
                </ol>
            </nav>
        </div>
    </div>
			...
			<div  class="row g-4">
			 ...
			 <?php
			   ...
			   $conn =connectdb();
				...
				$sql="Select * from add_waste WHERE status='Dynied'" ;
                ...
                <div  class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div style="float:left;" class="team-item rounded">
                        ...
                        <div class="team-text">
                           <h4 class="mb-0"> Name: '.$row["name"].'</h4><br>
							...
							<p style="color:red;" class="text-primary">Status: '.$row["status"].'</p>
							 </div>
                    </div>
                </div>';
