...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<a style="font-weight:bold;" href="useradd.php" class="nav-item nav-link">Add Waste</a>
                ...
                <a style="font-weight:bold;" href="contact.html" class="nav-item nav-link">Give Feedback</a>
   ...
   <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Added Wastes</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="userdb.php">Dashboard</a></li>
                    
                    <li class="breadcrumb-item active" aria-current="page">Added waste</li>
                </ol>
            </nav>
        </div>
    </div>
			...
			<div  class="row g-4">
			 ...
			 <?php
			   ...
			   $conn =connectdb();
				...
				$sql="Select * from add_waste WHERE email='{$_SESSION['EMAIL']}' " ;
                ...
                <div  class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div style="float:left;" class="team-item rounded">
                        ...
                        <div class="team-text">
                           <h4 class="mb-0"> Name: '.$_SESSION['NAME'].'</h4>
