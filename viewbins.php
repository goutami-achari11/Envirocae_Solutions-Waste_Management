...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<a style="font-weight:bold;" href="useradd.php" class="nav-item nav-link">Add waste</a>
                ...
                <a style="font-weight:bold;" href="payments.php" class="nav-item nav-link">Make payment</a>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Requested Bins</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="userdb.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">My bins</li>
                </ol>
            </nav>
        </div>
    </div>
			...
			<div  class="row g-4">
			 ...
			 <?php
			   ...
			   $conn =connectdb();
				...
				$sql="Select * from dbin WHERE phone='{$_SESSION['PHONE']}' " ;
                ...
                <div  class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div style="float:left;border: 1px solid green;width:300px;background-color:silver;" class="team-item rounded">
                        
                        <div  class="">
                           <h4 class="mb-0"> Name: '.$row["uname"].'</h4>
						   <p class="text-primary">Email: '.$row["email"].'</p>
							<p class="text-primary">Dust-bin Name: '.$row["dbname"].'</p>
							<p class="text-primary">Dust-bin Price: '.$row["dbprice"].'</p>
							...
							<p class="text-primary">Payment: '.$row["payment"].'</p>
        ...
        <div class="container py-5">
            <div class="row g-5">
               ...
               <a href="contact.html" style="color:white; font-size:19px; width:290px;" class="btn btn-link">Contact</a>
				<a href="payments.php" style="color:white; font-size:19px; width:290px;" class="btn btn-link">Make payment</a>
