...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Dust-Bins</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="admindb.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Added dust bins</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xxl py-5">
        <div  class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-5 mb-5">Added dust bins</h1>
            </div>
            <div  class="row g-4">
			<?php
			...
			<div  class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div style="float:left;" class="team-item rounded">
                        <img style="width:400px;height:400px;" class="img-fluid" src="dustbins/'.$row["dimg"].'" alt="">
                        <div class="team-text">
                           <h4 class="mb-0"> Dust-bin Name: '.$row["dbname"].'</h4>
                            <p class="text-primary">Price: '.$row["dbprice"].'</p>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a style="color:white; font-size:19px; width:290px;" class="btn btn-link" href="addbin.php">Add dust bin</a>
