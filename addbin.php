...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Add Dust-Bins</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="admindb.php">Dashboard</a></li>
                   <!-- <li class="breadcrumb-item"><a href="service.html">Add </a></li>-->
                    <li class="breadcrumb-item active" aria-current="page">Add Bins</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5">
              <center>  <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <p style="font-size:50px;font-weight:bold;" class="fw-bold text-primary">Add Dust-Bins</p>
                   <!--<h5 >Make your city clean.</h5>-->
                   
                    <form action="addbins.php" method="POST" enctype="multipart/form-data">
                        <div class="row g-3">
                             
							 <div class="col-12">
                                <div style="border:3px ridge green; border-radius:8px;" class="form-floating">
                                    <input type="text" class="form-control" name="dbname" required placeholder="Name of dust-bin" >
                                    <label for="dbname">Dust-Bin Name</label>
                                </div>
                            </div>
							<div class="col-12">
                                <div style="border:3px ridge green; border-radius:8px;" class="form-floating">
                                    <input type="text" class="form-control" name="dbprice" required placeholder="Price of dust-bin">
                                    <label for="dbprice">Dust-Bin Price</label>
                                </div>
                            </div>
                        
							 <div class="col-12">
                                <div style="border:3px ridge green; border-radius:8px;" class="form-floating">
                                    <input type="file" class="form-control" name="dimg" required >
                                    
                                </div>
                            </div>
                            
                            <div class="col-12"><center>
                                <button style="border:3px ridge green; border-radius:8px;width:250px;" class="btn btn-primary py-3 px-4" type="submit" name="btnsubmit">Add</button>
                            </center>
							</div>
                        </div>
                    </form>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
					...
					<a style="color:white; font-size:19px; width:290px;" class="btn btn-link" href="admindb.php">Dashboard</a>
                    <a style="color:white; font-size:19px; width:290px;" class="btn btn-link" href="viewfeedback.php">View feedback</a>
