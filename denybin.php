...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
			...
			<h3 class="display-3 text-white mb-4 animated slideInDown">Dynied asked bins</h3>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                  
                    <li class="breadcrumb-item"><a href="workerdb.php">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Dynied asked bins</li>
                </ol>
            </nav>
        </div>
    </div>
											...
											<tr>
														...
														<th style="color:white" class="bg-primary">Status</th>
																   ...
																   $conn =connectdb();
																	...
																	$sql="Select * from dbin WHERE status='Dynied'" ;
