...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <button type="button" class="navbar-toggler me-4" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
			...
			<a style="font-weight:bold;" href="useradd.php" class="nav-item nav-link">Add waste</a>
                ...
                <a style="font-weight:bold;" href="viewbins.php" class="nav-item nav-link">View Bins</a>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Pay here</h1>
        ...
        <div class="container">
            <div class="row g-5">
              <center>  <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <p style="font-size:50px;font-weight:bold;" class="fw-bold text-primary">Pay Here</p>
                    <form method="POST">
    <div class="row g-3">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <div style="border:3px ridge green; border-radius:8px;height:60px;" class="form-floating">
                <label for="dbname"><?php echo $_SESSION['DBNAME']; ?></label>
            </div>
        </div>
        <div class="col-md-6">
            <div style="border:3px ridge green; border-radius:8px;height:60px;" class="form-floating">
                <label for="dbprice" id="dbprice"><?php echo $_SESSION['DBPRICE']; ?></label>
            </div>
        </div>
		<div >
            <div  class="form-floating">
                <img style="width:500px;height:600px;" class="img-fluid" src="img/goutugpay.jpg" alt="">
            </div>
        </div>
		<h5>Or Pay this No.</h5>
		<div >
            <div  class="form-floating">
              <h5>7338516780</h5>  
            </div>
		...
		<div class="col-md-6">
         <div style="border:3px ridge green; border-radius:8px; width:700px;" class="form-floating">
               <input type="text" class="form-control" name="receipt" required placeholder="Your Email">
                 <label for="receipt">Payment Reference ID:</label>
        </div>
         </div>
			...
			<?php
			   ...
			   $conn =connectdb();
				$sql = "SELECT * FROM dbin WHERE email = '{$_SESSION['EMAIL']}'";
        ...
        <div class="team-social d-flex">
                                ...
                                <a  style="background-color:DarkGreen;color:white;" class="btn btn-square w-100 me-2" href="allactions.php?id='.$row["id"].'">Pay</a><br>
