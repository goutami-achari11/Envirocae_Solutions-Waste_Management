...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Add Waste</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="userdb.php">Dashboard</a></li>
                    
                    <li class="breadcrumb-item active" aria-current="page">Add waste</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5">
              <center>  <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <p style="font-size:50px;font-weight:bold;" class="fw-bold text-primary">Add Waste</p>
                        ...
                        <div class="row g-3">
							...
							<div  class="col-12">
                                ...
                                <div style="border:3px ridge green; border-radius:8px;" class="form-floating">
									<select class="form-control bg-light border-0" name="cage" id="cage" required >
											<option value="">Select waste type</option>
											<option value="dry">Dry</option>
											<option value="wet">Wet</option>
											<option value="renuvable">renuvable</option>
											<option value="Non-renevable">Non-renevable</option>
                            ...
                            <div class="col-12">
                                <div style="border:3px ridge green; border-radius:8px;" class="form-floating">
                                    <textarea class="form-control bg-light border-0" placeholder="address" name="address" style="height: 100px"></textarea>
                                    <label style="text-align:left;" for="address">Address</label>
                                </div>
                            </div>
							 <div class="col-12">
                                <div style="border:3px ridge green; border-radius:8px;" class="form-floating">
                            ...
                            <div class="col-12"><center>
                                <button style="border:3px ridge green; border-radius:8px;width:250px;" class="btn btn-primary py-3 px-4" type="submit" name="btnsubmit">Send Message</button>
                            </center>
							</div>
                        </div>
                    </form>
